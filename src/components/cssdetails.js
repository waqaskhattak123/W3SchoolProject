  ...
  return (
    <div>
      ...
      <div className="side_bar_contents">
        ...
        <NavLink to={"/cssdetails/introduction"}>Introduction</NavLink>

        <NavLink to={"/cssdetails/syntax"}>Syntax</NavLink>
        <NavLink to={"/cssdetails/selectors"}>Selectors</NavLink>
        <NavLink to={"/cssdetails/howto"}>How To</NavLink>
        <NavLink to={"/cssdetails/comments"}>Comments</NavLink>
        <NavLink to={"/cssdetails/colors"}>colors</NavLink>
        <NavLink to={"/cssdetails/background"}>Background</NavLink>
        <NavLink to={"/cssdetails/borders"}>Borders</NavLink>
        <NavLink to={"/cssdetails/padding"}>Padding</NavLink>
        <NavLink to={"/cssdetails/margin"}>Margin</NavLink>
        <NavLink to={"/cssdetails/height"}>Hieght/Width</NavLink>
        <NavLink to={"/cssdetails/boxmodel"}>Box Model</NavLink>
        <NavLink to={"/cssdetails/outline"}>Outline</NavLink>
        <NavLink to={"/cssdetails/text"}>Text</NavLink>
        <NavLink to={"/cssdetails/fonts"}>Fonts</NavLink>
        <NavLink to={"/cssdetails/icons"}>Icons Title</NavLink>
        <NavLink to={"/cssdetails/lists"}>Lists</NavLink>
        <NavLink to={"/cssdetails/links"}>Links</NavLink>
        <NavLink to={"/cssdetails/blockandinline"}>Block & Inline</NavLink>
        <NavLink to={"/cssdetails/classes"}>Classes</NavLink>
        <NavLink to={"/cssdetails/id"}>id</NavLink>
        <NavLink to={"/cssdetails/frames"}>Frames</NavLink>
